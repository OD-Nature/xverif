...
- 跑最小基线：
  - `PYTHON=/home/yian/miniconda3/bin/python make -C xdebug clean all`
  - `PYTHON=/home/yian/miniconda3/bin/python make -C xdebug test-fast`
...
- 入口和构建图阶段：
  - `PYTHON=/home/yian/miniconda3/bin/python make -C xdebug clean all`
  - `PYTHON=/home/yian/miniconda3/bin/python make -C xdebug schema-test`
  - `PYTHON=/home/yian/miniconda3/bin/python make -C xdebug contract-test`
  - `PYTHON=/home/yian/miniconda3/bin/python make -C xdebug unit-test`
- session/runtime 阶段：
  - `PYTHON=/home/yian/miniconda3/bin/python make -C xdebug pytest-session`
  - `PYTHON=/home/yian/miniconda3/bin/python make -C xdebug pytest-mcp`
  - `PYTHON=/home/yian/miniconda3/bin/python make -C xdebug combined-test`
- waveform/design 行为阶段：
  - `PYTHON=/home/yian/miniconda3/bin/python make -C xdebug test-synthetic`
  - `PYTHON=/home/yian/miniconda3/bin/python make -C xdebug test-realdata-smoke`
...
PYTHON=/home/yian/miniconda3/bin/python make test
PYTHON=/home/yian/miniconda3/bin/python make full-test
PYTHON=/home/yian/miniconda3/bin/python make -C xdebug test-nightly
PYTHONPATH=xverif_mcp/src:. /home/yian/miniconda3/bin/python -m pytest xverif_mcp/tests -q
```

如需真实 LSF：

```bash
PYTHON=/home/yian/miniconda3/bin/python XDEBUG_ENABLE_REAL_LSF=1 make -C xdebug test-mcp-real-lsf
```
